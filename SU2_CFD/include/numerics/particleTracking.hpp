...
class CSourcePGDMMS : public CNumerics {
 private:
 ...
 public:
   ...
   * \param[in] config - Definition of the particular problem.
   */
  CSourcePGDMMS(unsigned short val_nDim, unsigned short val_nVar, CConfig *config);
  ~CSourcePGDMMS() override = default;
...
class CSourcePTMMS : public CNumerics {
 private:
 ...
 public:
   ...
   * \param[in] config - Definition of the particular problem.
   */
  CSourcePTMMS(unsigned short val_nDim, unsigned short val_nVar, CConfig *config);
  ~CSourcePTMMS() override = default;
...
class CSourcePTStagMMS : public CNumerics {
 private:
 ...
 public:
   ...
   * \param[in] config - Definition of the particular problem.
   */
  CSourcePTStagMMS(unsigned short val_nDim, unsigned short val_nVar, CConfig *config);
  ~CSourcePTStagMMS() override = default;
